<div class="max-w-7xl mx-auto py-15 px-4">
    <x-slot name="header">
        <p class="dark:text-indigo-300">Editar Registro</p>
    </x-slot>
    ...
    <form action="" wire:submit.prevent="updateExpense" class="w-full max-w-7xl mx-auto">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide dark:text-white text-xs font-bold mb-2">Descrição Registro</label>
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide dark:text-white text-gray-700 text-xs font-bold mb-2">Valor do Registro</label>
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2">Tipo do Registro</label>
            ...
            <p class="w-full px-3 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs dark:text-white font-bold mb-2">Foto Comprovante</label>
                ...
                <img src="{{route('expenses.photo', $expense->id)}}" alt="" width="250" class="mt-3">

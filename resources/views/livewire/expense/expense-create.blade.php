<div class="max-w-7xl mx-auto py-15 px-4">
    ...
    <x-slot name="header">
        <p class="dark:text-indigo-300">Criar Registro</p>
    </x-slot>
    ...
    <form action="" wire:submit.prevent="createExpense" class="w-full max-w-7xl mx-auto">
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <p class="w-full px-3 mb-6 mt-4 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2">Descrição
                    Registro</label>
            ...
            <p class="w-full px-3 mb-6 mt-4 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2">Valor
                    do Registro</label>
            ...
            <p class="w-full px-3 mb-6 mt-4 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs dark:text-white font-bold mb-2">Tipo
                    do Registro</label>
            ...
            <p class="w-full px-3 mb-6 mt-4 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs dark:text-white font-bold mb-2">Foto
                    Comprovante</label>
                ...
                @if($photo)
                    <img src="{{$photo->temporaryUrl()}}" alt="" width="250" class="mt-3">
               @endif
            ...
            <p class="w-full px-3 mt-4 mb-6 md:mb-0">
                <label class="block uppercase tracking-wide text-gray-700 text-xs dark:text-white font-bold mb-2">Data do comprovante. Pode deixar em branco se o dia for hoje.</label>
